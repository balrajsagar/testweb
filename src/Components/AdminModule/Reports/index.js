...
// import SmartDataTable, { search, emptyTable } from 'react-smart-data-table'
import $ from 'jquery';
...
export default function AdminReports() {
    ...
    //creating table columns and data
    // var i = 1;
    // const reports = result.map((x,i) => {

    //     return {
    //         'S.No': i+1,
    //         'ProjectName ': x.result.project_name,
    //         'Sprint Name': `${x.result.sprint} - ${x.result.sprint_desc}`,
    //         'Assigned Story Points': x.result.completed !== null ? x.result.completed : 0,
    //         'Completed': x.result.completed !== null ? x.result.completed : 0,
    //         'Pending': x.result.pending !== null ? x.result.pending : 0,
    //     }
    // })
