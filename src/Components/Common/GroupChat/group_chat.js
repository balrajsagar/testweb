...
import { getMessages, updateChat, getGroupChatDetails } from './network';
import * as actions from './action';
import Alert from '../Alert';
import { isLoaded, isLoading } from '../Actions/loading';
import API from '../Network/API';
import { CHATAPI, MEMBERS } from '../Headers';
...
export default function MainTaskChatBox(props) {
    ...
    useEffect(() => {
        ...
        getGroupChatDetails(dispatch, getUser.user, props.data)
        ...
        if (state.comment !== "") {
            ...
            try {
                ...
                var response = await API.post("group_chat.php", {
                    ...
                    // msgId: msgId ? msgId : " ",
                    group_name: state.groupName, //for notifications
    ...
    const fileHandle = async (file) => {
        ...
        if (file !== "" && file.name !== undefined) {
            ...
            try {
                // eslint-disable-next-line
                var response = await API.post("group_chat1.php", data
                    , {}, false);
                getMessages(dispatch, getUser.user, props.data);
                dispatch(actions.comment(""));
                setChat(0)
        ...
        <div>
            ...
            >
                            ...
                            <div className="modal-content col-6 p-2" style={{ borderRadius: '10px' }}>
                                <div className="modal-header" style={{ backgroundColor: '#D2ECDF' }}>
                                    <div className="column">
                                        <h5 className="modal-title">Group Name -{state.groupName}</h5>
                                        <h6 className="modal-title">{MEMBERS} - {state.groupList}</h6>
                                    </div>
                                    <button style={{ backgroundColor: 'transparent', border: '0' }} type="button" onClick={props.handleModalClose} className="d-flex align-items-right" data-dismiss="modal"><i className="mdi mdi-close text-black"></i></button>
                                </div>
                ...
                {comments.message} </p> */}
                                ...
                                <div className="modal-footer m-1 justify-content-center">
                                    <div className="form-sample col-12">
                                        <form encType="multipart/form-data" method="post" autoComplete="off">
                                            ...
                                            {/* <label>Resume*</label> */}
                                            {chat === 1 ?
                                                <div><button style={{ backgroundColor: 'transparent', border: '0', float: "right" }} type="button" onClick={() => handleChatClose()} className="d-flex align-items-right" ><i className="mdi mdi-close text-black"></i></button>
                                                    <FilePond
                                                ...
                                                : chat === 2 ?
                                                    <div>
                                                        <button style={{ backgroundColor: 'transparent', border: '0', float: "right" }} type="button" onClick={() => handleChatClose()} className="d-flex align-items-right" ><i className="mdi mdi-close text-black"></i></button>
                                        ...
                                        <div className="row">
                                            {/* <div className="col-md-9">
                                                                <input type="text" className="form-control copyable-text selectable-text " ref={ref => { textInput = ref }} id="recipient-name" style={{ borderColor: 'grey', borderRadius: '20px',height:'2.2rem' }} 
                                            ...
                                            {/* <div className="col-md-2">
                                                                {/* <button type="button" className="btn btn-outline-success w-100" style={{ borderRadius: '20px',height:'2.2rem', }} onClick={() => sendMessage()}>Send</button> */}
                                            {/* {state.isLoading ? <RootLoader/> :<button type="button" className="btn btn-outline-success w-100" style={{ borderRadius: '20px',height:'2.2rem', }} onClick={() => sendMessage()}>Send</button>} */}
                                            {/* </div> */}
                                            {chat === 1 || chat === 2 ?
                                                <div className="col-md-2">
                                                    {/* <button type="button" className="btn btn-outline-success w-100" style={{ borderRadius: '20px',height:'2.2rem', }} onClick={() => sendMessage()}>Send</button> */}
                                                    ...
                                                    {/* <button type="button" className="btn btn-outline-success w-100" style={{ borderRadius: '20px',height:'2.2rem', }} onClick={() => fileHandle(docFile)}>Send</button> */}
                                                    {/* } */}
                                                </div> :
                                                <div className="col-md-2">
                                                    {/* <button type="button" className="btn btn-outline-success w-100" style={{ borderRadius: '20px',height:'2.2rem', }} onClick={() => sendMessage()}>Send</button> */}
                                ...
                                {/* <div className="modal-footer m-1">
                                
                                    <input type="text" className="form-control col-10 " id="recipient-name" style={{ borderColor: 'grey', borderRadius: '20px' }} 
                                     value={state.comment} onChange={(event) => dispatch(actions.comment(event.target.value))} onKeyPress={handleKeypress}/>
                                    <button type="submit" className="btn btn-outline-success" style={{ borderRadius: '20px' }} onClick={() => sendMessage()}>Send</button>
