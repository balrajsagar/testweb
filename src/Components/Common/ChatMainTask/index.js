...
import { CHATAPI, MAINTASK, MEMBERS, ATTACH_FILE } from '../Headers';
...
export default function MainTaskChatBox(props) {
    ...
    // console.log("geituser",commentDetails)
                            ...
                            <div className="modal-content col-6 p-2" style={{ borderRadius: '10px' }}>
                                <div class="modal-header" style={{ backgroundColor: '#D2ECDF' }}>
                                    <div className="column">
                                        <h6 class="modal-title">{MAINTASK} -{state.groupName}</h6>
                                        <p class="modal-title" title={state.groupList}>{MEMBERS} - {state.groupList}</p>
                                    </div>
                                    ...
                                    <div className="form-sample col-12">
                                        ...
                                        <div className="row">
                                            {/* <div className="col-md-9">
                                                                <input type="text" class="form-control copyable-text selectable-text " id="recipient-name" style={{ borderColor: 'grey', borderRadius: '20px',height:'2.2rem' }} 
