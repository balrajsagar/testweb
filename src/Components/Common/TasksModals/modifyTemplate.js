...
import { getUsers, getProjects,reassignMainTask, addUserStoryTemplate, addTemplate, addTemplateOnlyMod } from './network';
                        ...
                        <div className="user-modal-dialog d-flex justify-content-center">
                            <div className="modal-content col-lg-6 p-2" style={{ borderRadius: '10px' }}>
                                <div class="modal-header" style={{ backgroundColor: '#D2ECDF' }}>
                                    {props.data.action === "reassign" ? <h5 class="modal-title p-2">{REASSIGN} {MAINTASK}</h5>:<h5 class="modal-title p-2"> Add User story</h5>}
                                ...
                                onClick={(event) => { addUserStoryTemplate(state, dispatch, getUser.user,props.handleClose, props.data.data.story_title)}} 
                                ...
                                >Add</button> &nbsp;&nbsp;
                                <button type="button" class="btn btn-outline-warning" style={{ borderRadius: '20px' }} 
                                    ...
                                    <button type="button" class="btn btn-outline-primary" style={{ borderRadius: '20px' }} 
                                    onClick={(event) => { addTemplateOnlyMod(state, dispatch, getUser.user,props.handleClose, props.data.data.story_title) }}>Save as a Template</button>
                                    </div>}
