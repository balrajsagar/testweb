...
import { getUsers, addMainTask, getProjects, addMainTaskTemplate, addTemplateOnly } from './network';
                                    ...
                                    {state.isLoading ? <RootLoader /> :
                                        <div>
                                            ...
                                            <button type="button" class="btn btn-outline-success" style={{ borderRadius: '20px' }}
                                                onClick={(event) => { addMainTask(state, dispatch, getUser.user, props.handleClose) }}>Add</button>&nbsp;&nbsp;
                                            <button type="button" class="btn btn-outline-warning" style={{ borderRadius: '20px' }}
                                                onClick={(event) => { addMainTaskTemplate(state, dispatch, getUser.user, props.handleClose) }}>Add & Save as a Template</button>&nbsp;&nbsp;
                                            <button type="button" class="btn btn-outline-info" style={{ borderRadius: '20px' }}
                                                onClick={(event) => { addTemplateOnly(state, dispatch, getUser.user, props.handleClose) }}>Save as a Template</button>
                                        </div>}
