...
import { addKanban, getProjects } from './network';
import { KANBAN, KANBAN_NAME } from '../Headers';
                        ...
                        <div className="user-modal-dialog d-flex justify-content-center">
                            <div className="modal-content col-lg-6 p-2" style={{ borderRadius: '10px' }}>
                                <div class="modal-header" style={{ backgroundColor: '#D2ECDF' }}>
                                    <h5 class="modal-title p-2">Add {KANBAN}</h5>
                                        ...
                                        <form >
                                           {/* {props.data.action === "addSprint" ? <div class="form-group row p-2" style={{flexDirection:"row"}}>
                                            ...
                                            <div class="form-group row p-2 " style={{marginTop:-30}}>
                                                <label for="recipient-name" class="col-form-label pt-4 ">{KANBAN} Name<span style={{ color: "red" }} >*</span></label>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-outline-success" style={{ borderRadius: '20px' }} onClick={(event) => { addKanban(state, dispatch, getUser.user,props.handleClose) }}>Add</button>
                                </div>
